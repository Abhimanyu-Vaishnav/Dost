...
export function StoryFeed({ currentUserId, currentUserAvatar }: { currentUserId: string, currentUserAvatar: string | null }) {
  ...
  return (
    <div style={{
      ...
      {/* 1. Current User Story Item (With + Badge for 1-tap quick creation & Dost Primary Accent Ring) */}
      <div 
      ...
      >
        <div style={{ 
          ...
          background: hasOwnStory ? "var(--color-primary, #1d9bf0)" : "var(--color-border)"
        }}>
          ...
          <div 
            ...
            style={{
              ...
              border: "2px solid var(--color-bg-base)", boxShadow: "0 2px 6px rgba(0,0,0,0.3)"
            }}
            title="Create Story"
          >
      ...
      {/* 2. Followed Creators Active Stories (Dost Primary Accent Ring) */}
      {groupedStories.map((group, index) => {
        ...
        return (
          ...
          >
            <div style={{ 
              position: "relative", width: "64px", height: "64px", borderRadius: "50%", padding: "2px", 
              background: "var(--color-primary, #1d9bf0)" // Dost Primary Accent Ring
            }}>
